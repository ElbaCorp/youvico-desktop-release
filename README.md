...
<p align="center">Windows · macOS · Linux</p>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <img src="assets/ai-create.svg" width="28" height="28" alt="">
      <h3>상상을 AI 영상과 이미지로</h3>
      <p>상상하던 아이디어를 AI로 만들어보세요. 프로젝트 안에서 영상과 이미지를 생성하고 팀과 함께 발전시키세요.</p>
    </td>
    <td width="50%" valign="top">
      <img src="assets/edit.svg" width="28" height="28" alt="">
      <h3>생성에서 편집까지 이어서</h3>
      <p>생성한 영상과 업로드한 소스를 편집하고, 자막을 더해 원하는 결과물로 완성하세요.</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <img src="assets/review.svg" width="28" height="28" alt="">
      <h3>다양한 콘텐츠를 한곳에서</h3>
      <p>영상, 오디오, 이미지, PDF와 문서를 열어보고 파일에 대한 피드백을 함께 확인하세요.</p>
    </td>
    <td width="50%" valign="top">
      <img src="assets/feedback.svg" width="28" height="28" alt="">
      <h3>수정할 지점을 정확하게</h3>
      <p>영상의 특정 시점이나 구간에 댓글을 남기고, 펜·도형·텍스트로 화면에 직접 표시하세요.</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <img src="assets/projects.svg" width="28" height="28" alt="">
      <h3>파일과 팀의 대화를 함께</h3>
      <p>프로젝트별 파일과 폴더를 정리하고, 댓글·답글·멘션으로 필요한 팀원과 대화를 이어가세요.</p>
    </td>
    <td width="50%" valign="top">
      <img src="assets/model3d.svg" width="28" height="28" alt="">
      <h3>3D 모델도 직접 살펴보기</h3>
      <p>3D 뷰어에서 모델을 회전하고 확대하며 여러 각도에서 확인하세요.</p>
    </td>
  </tr>
</table>
...
<details>
<summary>Assets에 파일이 여러 개 보여요</summary>
